...
require(['dojo/ready', 'esri/layers/WebTiledLayer', 'esri/layers/WMSLayer', 'esri/layers/WMSLayerInfo', 'esri/geometry/Extent',  'esri/dijit/Search'],
    function (ready, WebTiledLayer, WMSLayer, WMSLayerInfo, Extent, Search) {
        ready(function () {
            gWMSLayer = WMSLayer;
            gExtent = Extent;
...
function addChirps()
{
     wmsLayer20 = new gWMSLayer("http://chirps.nsstc.nasa.gov/cgi-bin/servirmap?SERVICE=WMS&REQUEST=GetMap&VERSION=1.1.0&",
                        {
                            resourceInfo: {
                                extent: new gExtent(-180, -90, 180, 90, { wkid: 4326 }),
                                layerInfos: []
                            },
                            visibleLayers: ["country"]
                        }
                );
    wmsLayer20.spatialReferences[0] = 4326;
