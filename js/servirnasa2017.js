...
function submitDataRequest() 
{
    ...
    if (myOpVal6 == "6")
        operationValue = "6";
    else if(myOpVal6=="999") operationValue = $('#operationmenu').val();
    ...
    var esi_DataType_OptionValue = "29";
    var imerg_DataType_OptionValue = "IMERG1Day";
    var chirps_DataType_OptionValue = "0";
    var wNdvi_DataType_OptionValue = "1";
    // New Params
    ...
    if (dataType_Option_Value.toLowerCase() == climate_DataType_OptionValue.toLowerCase()) {
        ...
        if (dataType_Option_Value.toLowerCase() == esi_DataType_OptionValue.toLowerCase()) {
            // New Params
            dateType_Category = "ESI";
        }
        if (dataType_Option_Value.toLowerCase() == imerg_DataType_OptionValue.toLowerCase()) {
            // New Params
            dateType_Category = "IMERG";
        }
        if (dataType_Option_Value.toLowerCase() == chirps_DataType_OptionValue.toLowerCase()) {
            // New Params
            dateType_Category = "CHIRPS";
        }
        if (dataType_Option_Value.toLowerCase() == wNdvi_DataType_OptionValue.toLowerCase()) {
            // New ParamsdateType_Number
            dateType_Category = "NDVI";
        }
            ...
            var dateBeginValue_Raw = $("#datepickerbegin").val();
            var dateEndValue_Raw = $("#datepickerend").val();
