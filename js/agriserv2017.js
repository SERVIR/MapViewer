...
function get_raw_As_CSV() {
   // alert("Coming soon");
    ...
    aoi0granules = calculateAllGranules(aoi0NDVI_Granules, aoi0CHIRPS_Granules);
    ...
    aoi1granules = calculateAllGranules(aoi1NDVI_Granules, aoi1CHIRPS_Granules);
    ...
    //downloadTextFile(theUniqueID+".csv", outputstring)
    downloadTextFile("Agriserv_Raw_Data.csv", csvOutputString);     // Depends on 'servirnasa.js'
...
function agriserv_AJAX__Submit_New_DataRequest(dataTypeValue, operationValue, dateintervalValue, dateBeginValue, dateEndValue, isUsePolystring, polygonString, layerid, featureids, localJobID) {
    ...
    // console.info("*******************************");
    //console.info(req_Data['geometry']);
